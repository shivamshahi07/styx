                        ...
                        <div className="row g-0">
                            ...
                            <div className="col-md-6 border-start m-auto p-3">
                                <div className="p-3 right-side">
                                    ...
                                    <h3>${product.price}</h3>
                                    < div className="d-flex justify-content-start small text-primary mb-3" >
                                        <h6 className="mt-1">
                                    ...
                                    <div className="buttons d-flex flex-row mb-2 gap-2">
                                        ...
                                        <button className="btn btn-primary" onClick={() => { dispatch(addToCart(product)) }}><i className="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
