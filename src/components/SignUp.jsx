                        ...
                        <div className="login-wrap p-4 p-md-5">
                            ...
                            <form className="signin-form">
                                ...
                                <div className="form-group">
                                   <Link className='nav-link text-primary' to="/login" ><button className="form-control btn btn-primary rounded submit px-3">Sign Up</button></Link>                                </div>

                            </form>
                            <p className="text-center mt-2">Already a user ? <Link className='nav-link text-primary' to="/login" >Login</Link></p>
                        </div>
                    </div>
                </div>
            </div>
